...
echo "ANNA1304WG" > strings/0x409/serialnumber
echo "Techanna Inc." > strings/0x409/manufacturer
echo "Wearable Glove Keyboard/Mouse" > strings/0x409/product
